...
13. Added Encoder to use with a wheel on top of the main knob an simulate pulls on any of the axis (main use is simulating zoom like the mouse wheel), by [@JoseLuisGZA](https://github.com/JoseLuisGZA) and rewritten by AndunHH.
